  ...
  return (
    <div className='container'>
      <div className="resume resume-para">
        ...
        <ResumeDiv h5='experience' pre='Jan 2018 - July 2018 (Full-Time)' p='Worked as Front-End Developer with a team of developers, managers in an agile environment to solve problems. This Portfolio is built in ReactJS with BootStrap optimised for almost all screen resolutions.' />
